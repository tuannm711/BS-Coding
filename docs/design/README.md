...
| Name | Where | Line |
| --- | --- | --- |
| `--output` | [02-agent-runtime.md#what-a-coordinator-is-told-and-what-it-can-reach](02-agent-runtime.md#what-a-coordinator-is-told-and-what-it-can-reach) | 175 |
...
| `appendMessage` | [02-agent-runtime.md#types-that-carry-it](02-agent-runtime.md#types-that-carry-it) | 70 |
...
| `compactIfOverThreshold` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 207 |
...
| `COORDINATE_RULES` | [02-agent-runtime.md#two-ways-to-hand-work-off](02-agent-runtime.md#two-ways-to-hand-work-off) | 119 |
...
| `getItems` | [02-agent-runtime.md#types-that-carry-it](02-agent-runtime.md#types-that-carry-it) | 70 |
...
| `LlmClient` | [02-agent-runtime.md#pieces](02-agent-runtime.md#pieces) | 21 |
| `LoopDeps` | [02-agent-runtime.md#data-flow](02-agent-runtime.md#data-flow) | 41 |
...
| `MAX_COMPACT_PER_RUN` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 207 |
| `modelIds` | [06-ui-shell.md#the-fleet-panel](06-ui-shell.md#the-fleet-panel) | 153 |
| `modeNote` | [02-agent-runtime.md#what-a-coordinator-is-told-and-what-it-can-reach](02-agent-runtime.md#what-a-coordinator-is-told-and-what-it-can-reach) | 175 |
...
| `pushTurn` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 207 |
...
| `runAssignment` | [02-agent-runtime.md#two-ways-to-hand-work-off](02-agent-runtime.md#two-ways-to-hand-work-off) | 119 |
...
| `SessionRunner` | [02-agent-runtime.md#pieces](02-agent-runtime.md#pieces) | 21 |
...
| `SUBAGENT_CONFIGS` | [02-agent-runtime.md#two-ways-to-hand-work-off](02-agent-runtime.md#two-ways-to-hand-work-off) | 119 |
| `systemSuffix` | [02-agent-runtime.md#what-a-handoff-borrows](02-agent-runtime.md#what-a-handoff-borrows) | 145 |
| `takeSteers` | [02-agent-runtime.md#design-decisions](02-agent-runtime.md#design-decisions) | 85 |
...
| `tests/unit/agent-loop.test.ts` | [02-agent-runtime.md#types-that-carry-it](02-agent-runtime.md#types-that-carry-it) | 70 |
...
| `text-delta` | [02-agent-runtime.md#data-flow](02-agent-runtime.md#data-flow) | 41 |
| `titleBarOverlay` | [06-ui-shell.md#design-decisions](06-ui-shell.md#design-decisions) | 65 |
| `toLlmMessages(getItems())` | [02-agent-runtime.md#data-flow](02-agent-runtime.md#data-flow) | 41 |
| `tools/` | [02-agent-runtime.md#design-decisions](02-agent-runtime.md#design-decisions) | 85 |
...
| `turnId` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 207 |
| `undoCall` | [05-sessions.md#design-decisions](05-sessions.md#design-decisions) | 66 |
| `undoTurn` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 207 |
| `visibleToolDefs` | [02-agent-runtime.md#two-ways-to-hand-work-off](02-agent-runtime.md#two-ways-to-hand-work-off) | 119 |

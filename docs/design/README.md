...
| Name | Where | Line |
| --- | --- | --- |
| `--output` | [02-agent-runtime.md#what-a-coordinator-is-told-and-what-it-can-reach](02-agent-runtime.md#what-a-coordinator-is-told-and-what-it-can-reach) | 194 |
...
| `compactIfOverThreshold` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 226 |
| `compileNeutralContext` | [02-agent-runtime.md#one-conversation-format](02-agent-runtime.md#one-conversation-format) | 146 |
...
| `src/main/agent/AGENTS.md` | [02-agent-runtime.md#design-decisions](02-agent-runtime.md#design-decisions) | 86 |
| `src/main/agent/llm.ts` | [02-agent-runtime.md#pieces](02-agent-runtime.md#pieces) | 22 |
| `src/main/agent/loop.ts` | [02-agent-runtime.md#pieces](02-agent-runtime.md#pieces) | 22 |
...
| `SUBAGENT_CONFIGS` | [02-agent-runtime.md#two-ways-to-hand-work-off](02-agent-runtime.md#two-ways-to-hand-work-off) | 120 |
| `systemSuffix` | [02-agent-runtime.md#what-a-handoff-borrows](02-agent-runtime.md#what-a-handoff-borrows) | 164 |
| `takeSteers` | [02-agent-runtime.md#design-decisions](02-agent-runtime.md#design-decisions) | 86 |
...
| `tests/unit/agent-loop.test.ts` | [02-agent-runtime.md#types-that-carry-it](02-agent-runtime.md#types-that-carry-it) | 71 |
...
| `text-delta` | [02-agent-runtime.md#data-flow](02-agent-runtime.md#data-flow) | 42 |
| `thoughtSignature` | [02-agent-runtime.md#one-conversation-format](02-agent-runtime.md#one-conversation-format) | 146 |
| `titleBarOverlay` | [06-ui-shell.md#design-decisions](06-ui-shell.md#design-decisions) | 65 |
| `toLlmMessages(getItems())` | [02-agent-runtime.md#data-flow](02-agent-runtime.md#data-flow) | 42 |
| `toLlmMessages` | [02-agent-runtime.md#one-conversation-format](02-agent-runtime.md#one-conversation-format) | 146 |
| `tool-call` | [02-agent-runtime.md#one-conversation-format](02-agent-runtime.md#one-conversation-format) | 146 |
| `tool-result` | [02-agent-runtime.md#one-conversation-format](02-agent-runtime.md#one-conversation-format) | 146 |
| `tools/` | [02-agent-runtime.md#design-decisions](02-agent-runtime.md#design-decisions) | 86 |
...
| `turnId` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 226 |
| `undoCall` | [05-sessions.md#design-decisions](05-sessions.md#design-decisions) | 66 |
| `undoTurn` | [02-agent-runtime.md#known-limits](02-agent-runtime.md#known-limits) | 226 |
| `visibleToolDefs` | [02-agent-runtime.md#two-ways-to-hand-work-off](02-agent-runtime.md#two-ways-to-hand-work-off) | 120 |

...
| [Design decisions](#design-decisions) | 81-123 | `ProviderUsage.status`, `'near-limit'`, `docs/technical-debt.md`, `primaryUsedPercent`, `providerError`, `hasRemainingQuota` |
| [Known limits](#known-limits) | 124-132 | `openai.ts`, `antigravity.ts`, `fetchUsage` |
<!-- /toc -->

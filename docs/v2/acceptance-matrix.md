...
|---|---|---|
| `AC-CORE-01` | PASS | `tests/e2e/v2-core-flow.spec.ts`, `tests/e2e/v2-bootstrap.spec.ts` |
...
| `AC-UX-01` | PASS | `tests/unit/v2/renderer-navigation.test.tsx`, `tests/e2e/v2-bootstrap.spec.ts` |
...
| `TEST-REG-07` | PASS | `tests/unit/v2/preload-contract.test.ts`, `tests/unit/v2/renderer-security-boundary.test.ts`, `tests/e2e/v2-bootstrap.spec.ts` |
